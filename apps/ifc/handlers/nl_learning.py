...
class NLLearningStore:
    ...
    def find_exact(self, query_normalized: str) -> LearnedPattern | None:
    ...
    def find_similar(self, query: str, threshold: float = 0.7) -> LearnedPattern | None:
        """
    ...
    def get_intent(self, query: str) -> str | None:
        """

...
class RoomAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (
            None,
            {"fields": ("ifc_model", "floor", "ifc_guid")},
        ),
        (
            "Stammdaten",
            {"fields": ("number", "name", "long_name")},
        ),
        (
            "Geometrie",
            {
...
class WindowAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Eigenschaften",
            {"fields": ("material", "glazing_type", "u_value")},
        ),
        (
            "IFC Properties",
...
class DoorAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Stammdaten",
            {"fields": ("number", "name", "door_type")},
        ),
        ("Geometrie", {"fields": ("width", "height")}),
        (
            "Eigenschaften",
            {"fields": ("material", "fire_rating")},
        ),
    )
